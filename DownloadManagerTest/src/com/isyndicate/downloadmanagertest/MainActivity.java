package com.isyndicate.downloadmanagertest;
...
public class MainActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.startDownload:
			...
			Uri Download_Uri = Uri.parse("http://demo1.mysamplecode.com/Sencha_Touch/CountryServlet?start=0&limit=999");
	...
	private void checkStatus(Cursor cursor) {
		...
		Toast toast = Toast.makeText(MainActivity.this, statusText + "\n" + reasonText, Toast.LENGTH_LONG);
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (downloadReference == referenceId) {
				...
				try {
					...
					Toast toast = Toast.makeText(MainActivity.this, "Downloading of data just finished", Toast.LENGTH_LONG);
					toast.setGravity(Gravity.TOP, 25, 400);
					toast.show();
