...
public class RssFeedOperation implements Operation {
    ...
    public static final String PARAM_FEED_URL = "com.is.datadroidsample.extra.feedUrl";

    @Override
    public Bundle execute(Context context, Request request) throws ConnectionException,
            DataException {
        ConnectionResult result = new NetworkConnection(context, request.getString(PARAM_FEED_URL)).execute();
